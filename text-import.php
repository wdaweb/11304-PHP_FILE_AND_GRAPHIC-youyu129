 ...
 */
        ...
        function getfile($path)
        {
            ...
            $table_line        = fgets($table_file);
            $table_header_cols = explode(",", trim($table_line));
            echo "<table>";
            echo "<tr class='header'>";
            foreach ($table_header_cols as $table_hc) {
                echo "<th>{$table_hc}</th>";
            }
            echo "</tr>";

            while ($table_line = fgets($table_file)) {
                $table_cols = explode(",", trim($table_line));
                echo "<tr>";
                foreach ($table_cols as $table_col) {
                    echo "<td>{$table_col}</td>";
                }
                echo "</tr>";
            }
            fclose($table_file);
